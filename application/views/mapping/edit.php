                        ...
                        <div class="box-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_barang" class="form-control" id="nama_barang" value="<?= $barang['nama_barang']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="jenis_barang">Jenis Barang</label>
                                    <input type="text" name="jenis_barang" class="form-control" id="jenis_barang" value="<?= $barang['jenis_barang']; ?>" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="qty">Quantity</label>
                                    <input type="number" name="qty" class="form-control" id="qty" value="<?= $barang['qty']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php foreach($lokasi as $lok) : ?>
                                        <?php if($lok['lokasi'] == $barang['lokasi']) : ?>
                                            <option value="<?= $lok['lokasi'] ?>" selected><?= $lok['lokasi'] ?></option>
                                        <?php else : ?>
