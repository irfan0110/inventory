        ...
        <section class="content">
            <div class="box box-info">
                <div class="box-header">
                    <h3 class="box-title">Cetak Laporan Periodik Barang Keluar</h3>
                </div>
                <div class="box-body">
                    <form action="<?= base_url(); ?>Barang_keluar/pdf_periodik" method="POST" target="_blank">
            ...
            <div class="box box-warning">
                <div class="box-header">
                    <h3 class="box-title">Cetak Semua Laporan Barang Keluar</h3>
                </div>
                <div class="box-body">
                    <form action="<?= base_url(); ?>Barang_keluar/cetak" method="POST" target="_blank">
